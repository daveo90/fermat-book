image::https://raw.githubusercontent.com/bitDubai/media-kit/master/MediaKit/Coins/Platform%20Coins/COR/COR.jpg[Core]

== Chapter 3: Fermat Core Platform
This is the *core platform* of the Fermat Multi-platform System. It contains the bottommost levels of layers in the stack layers. Its components encapsulate the basic definitions and functionalities that let Fermat operate as an _integrated system_. +
...
.Platform components
Fermat core :: 
Initializes all system-wide Plug-ins and starts a specific *core component* for each platform/superlayer running on Fermat, which in return initializes the specific set of platform/superlayer Plug-ins.
Android core :: 
